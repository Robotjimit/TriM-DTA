...
class EGNN(nn.Module):
    def __init__(self, in_node_nf, hidden_nf, out_node_nf, in_edge_nf=0, act_fn=nn.SiLU(), n_layers=3, residual=True, attention=False, normalize=True, tanh=False):
        ...
        self.fc = FC(self.hidden_nf, self.hidden_nf, 3, 0.1, out_node_nf)
    ...
    def forward(self, h, x, edges, batch, edge_attr=None):
...
if __name__ == '__main__':
    ...
    # model = EGNN(35, 256, 1, n_layers=3, normalize=True)

    # flops, params = profile(model, inputs=(x, pos, edge_index, batch, ))
